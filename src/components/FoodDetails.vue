      ...
      <div class="flex flex-col md:flex-row -mx-4">
        <div class="md:flex-1 px-4">
          <div
            ...
            <img class="object-contain max-h-[290px] w-96 hover:scale-125 " :src="details.url" alt="Product Image">
          </div>
          <div class="flex -mx-2 mb-4">
            <div class="w-1/2 px-2">
              <button v-on:click="goToCart"
                class="w-full bg-gray-900 dark:bg-gray-600 text-white py-2 px-4 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700">View
                cart items
              </button>
            </div>
            <div class="w-1/2 px-2">
        ...
        <div class="md:flex-1 px-4">
          ...
          <div class="flex mb-4">
            <div class="mr-4">
              <span class="font-bold text-gray-700 dark:text-gray-300">{{ details.price }}</span>
