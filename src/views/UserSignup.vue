<template>
    ...
    <div class="flex h-screen w-full items-center justify-center">
        ...
        <div
            class="z-10 max-w-3xl h-[400px] w-[550px] p-6 bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg md:p-16 opacity-80 md:p-16 opacity-80 rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
